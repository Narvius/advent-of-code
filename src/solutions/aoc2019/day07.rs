...
fn permutations(k: usize) -> Vec<Vec<i32>> {
    fn inner(k: usize, values: &mut [i32]) -> Vec<Vec<i32>> {
    ...
    inner(k, &mut (0..k as i32).collect::<Vec<_>>())
}
